...
def default_stub_files():
    ...
    return create_targets(
        ...
        + [
            ...
            "out/soong/.intermediates/frameworks/base/test-mock/android.test.mock.stubs.source.test/android_common/everything/android.test.mock.stubs.source.test-stubs.srcjar",
        ]
    )
...
def default_doc_stub_files():
    ...
    return create_targets(
        ...
        + [
            # Car doc stubs
            "out/soong/.intermediates/packages/services/Car/car-lib/car-doc-stubs/android_common/exportable/car-doc-stubs-stubs.srcjar",
        ]
    )
...
def default_annotation_zip_files():
    ...
    return create_targets([
        "out/soong/.intermediates/frameworks/base/api/android-non-updatable-doc-stubs-system-server/android_common/everything/android-non-updatable-doc-stubs-system-server_annotations.zip",
