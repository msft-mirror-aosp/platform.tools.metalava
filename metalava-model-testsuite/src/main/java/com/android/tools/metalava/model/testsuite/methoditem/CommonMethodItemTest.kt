...
class CommonMethodItemTest : BaseModelTest() {
    ...
    fun `Test throws method type parameter extends Throwable`() {
        runCodebaseTest(
            ...
            assertEquals(throwsType.asErasedClass()!!.qualifiedName(), JAVA_LANG_THROWABLE)
        }
    }
    ...
    fun `Test throws method type parameter does not extend Throwable`() {
        ...
        runCodebaseTest(
            ...
            assertFalse(throwsType.asErasedClass()!!.extends(JAVA_LANG_THROWABLE))
        }
    }
    ...
    fun `Test throws method class does not exist`() {
        ...
        runCodebaseTest(
            ...
            assertNull(throwsType.asErasedClass())
        }
    }
