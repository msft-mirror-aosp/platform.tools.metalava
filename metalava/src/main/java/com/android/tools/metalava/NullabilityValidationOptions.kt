...
class NullabilityValidationOptions() :
    ...
    /**
     * Returns a [ComputedNullabilityValidationOptions] instance based on the current state of the
     * options.
     */
    fun compute(reporter: Reporter): ComputedNullabilityValidationOptions {
        return ComputedNullabilityValidationOptions(
            nullabilityErrorsFatal,
            nullabilityWarningsTxt,
            validateNullabilityFromMergedStubs,
...
/**
 * Options related to nullability validation and additional values computed based on those options.
 */
class ComputedNullabilityValidationOptions(
    /** Whether nullability validation errors should be considered fatal. */
    nullabilityErrorsFatal: Boolean,
