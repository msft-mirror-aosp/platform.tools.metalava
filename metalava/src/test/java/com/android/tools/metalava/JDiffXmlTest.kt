...
import com.android.tools.metalava.cli.signature.JDiffTestConfig
import com.android.tools.metalava.cli.signature.SignatureToJDiffCommandTest
import com.android.tools.metalava.cli.signature.jdiffConversionTest
import com.android.tools.metalava.model.text.FileFormat
import org.junit.Test

class JDiffXmlTest : SignatureToJDiffCommandTest() {

    private fun jdiffTest(body: JDiffTestConfig.() -> Unit) {
        jdiffConversionTest {
            // Assume that any file without a header is 2.0 file.
